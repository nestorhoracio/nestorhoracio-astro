...
El deploy ya está hecho y verificado (sesión 11, ver changelog) — pasos 1-6 del plan original, completados. Queda solo el cierre del lado de WordPress:
...
- **`nestorhoracio.com` está en producción sirviendo el sitio Astro** desde hoy. Queda pendiente solo el borrado definitivo de WordPress (pasos 7-9 en "Próximo"), pospuesto a propósito unos días para confirmar estabilidad.
