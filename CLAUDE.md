...
- **Logo**: isotipo circular NH. Dos variantes según modo, en `wp-content/uploads/2025/10/`: `isotipo-full-color.png` (claro) y `isotipo-black.png` (oscuro) — hay que bajarlas como asset real cuando se construya el Header (no se hizo todavía).
